...
<div class="row">
  ...
  <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-xs-12">
    <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
      <div class="card-header text-center"><img src="{{ asset('imgs/editor.svg') }}"> </img></div>
      <div class="card-body">
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card" style="background-color: #f37bad">  
  <div class="card-header text-center"><img height="42" width="42" src="{{ asset('imgs/busquedas.svg
      ') }}">
  </div>
          <h5 class="card-title text-center" style="color:white">Area de Consultas</h5>
  <div class="card-body text-center" style="color:white">
      <p>Consultas por Id, Tipo, Proyecto, Estado de Revisión</p>
